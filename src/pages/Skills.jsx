...
export function Skills2() {
  return (
    <>
      <div className="bg-[url('/space.jpg')] bg-cover bg-no-repeat bg-center pt-10 pb-10 px-4 md:px-20">

        <div className="text-white text-center md:text-left">
          <h2 className="text-2xl sm:text-3xl font-bold">Frontend</h2>
          <div className="w-20 h-1 bg-blue-500 mt-2 rounded mx-auto md:mx-0"></div>
        </div>
