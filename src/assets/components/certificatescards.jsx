export function StratwarsCard() {
  return (
   ...
   Third prize DTU Stratwars
      </h2>

      <p className="text-gray-300 mb-6 pt-20 pb-5">
        Got third prixe at DTU 
        Stratwars from
         1000+ participants
      </p>
<a
...
export function MissionmalamaalCard() {
  return (
    <div className="bg-[#0b1120] max-w-md pt-6 pl-6 rounded-2xl text-white shadow-lg border border-white/10 relative h-100 w-100 pt-20 mb-20">
      <img
        src="/bvcoelogo.jpg"
      ...
      />
      <h2 className="text-2xl font-bold mb-2">
   Third prize BVCOE Ideathon
      </h2>

      <p className="text-gray-300 mb-6 pt-20 pb-5">
        Got third prixe at BVCOE 
        Ideathon from
         2000+ participants
      </p>
<a
